...
public class StringsConstants {
    ...
    public static final String UNVISIBLE_u202A = "\u202A";
    public static final String REFERENCE_UPDATER = "ReferenceUpdater_";
    public static final String LOG = ".log";
    public static final String NAME ="name";
    public static final String UUIDKEY = "uuidkey";
    public static final String MESSAGE_ACTION = "MessageAction";
    public static final String FULL_NAME_SOURCE ="fullNameSource";
